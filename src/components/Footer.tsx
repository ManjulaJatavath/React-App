...
const Footer: React.FC = () => {
    ...
    return (
        <footer className="bg-pink-800 text-white py-8 mt-10">
            ...
            <div className="container mx-auto px-4 text-center mt-8">
                <p>© {currentYear}  Welcome To My React App. Developed by Manjula Kethavath</p>
                <p>© Passianate About Full stack Developer</p>
            </div>
        </footer>
    );
};
